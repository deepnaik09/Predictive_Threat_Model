...
def train_naive_bayes(input_path="data/featured_data.csv", model_output="models/naive_bayes_model.pkl"):
    """Trains a Naive Bayes model for loan default prediction and saves it."""
    ...
    print(f"✅ Naive Bayes model trained and saved at {model_output}")
